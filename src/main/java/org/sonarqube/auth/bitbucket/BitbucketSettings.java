  ...
  public static List<PropertyDefinition> definitions() {
    ...
    return Arrays.asList(
      ...
      PropertyDefinition.builder(TEAM_RESTRICTION)
        .name("Teams:")
        .description("Only members of these teams will be able to authenticate to the server. If a user is a member of any of the teams listed they will be authenticated. (leave the field empty for not apply any restriction or put one or more team separate by ',')")
        .category(CATEGORY)
        .subCategory(SUBCATEGORY)
        .index(index++)
        .build(),
